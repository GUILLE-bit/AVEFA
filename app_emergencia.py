# Create a Streamlit app that downloads .npy weights from GitHub RAW,
# validates URLs, uses matplotlib, and keeps previous behavior.
    ...
    def _fetch_bytes(url: str, timeout: int = 20) -> bytes:
        ...
        try:
            req = Request(url, headers={
                "User-Agent": "Mozilla/5.0 (Streamlit ANN Loader)"
            })
...
out_path = "/mnt/data/app_emergencia_github_npy_matplotlib.py"
